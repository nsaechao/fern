...
[![go shield](https://img.shields.io/badge/go-docs-blue)](https://pkg.go.dev/github.com/api-wide-base-path/fern)
...
```sh
go get github.com/api-wide-base-path/fern
```
...
```go
import fernclient "github.com/api-wide-base-path/fern/client"
