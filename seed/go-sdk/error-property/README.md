...
[![go shield](https://img.shields.io/badge/go-docs-blue)](https://pkg.go.dev/github.com/error-property/fern)
...
```sh
go get github.com/error-property/fern
```
...
```go
import fernclient "github.com/error-property/fern/client"
