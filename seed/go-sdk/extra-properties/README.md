...
[![go shield](https://img.shields.io/badge/go-docs-blue)](https://pkg.go.dev/github.com/extra-properties/fern)
...
```sh
go get github.com/extra-properties/fern
```
...
import (
	...
	fernclient "github.com/extra-properties/fern/client"
)
