...
[![go shield](https://img.shields.io/badge/go-docs-blue)](https://pkg.go.dev/github.com/file-download/fern)
...
```sh
go get github.com/file-download/fern
```
...
```go
import fernclient "github.com/file-download/fern/client"

client := fernclient.NewClient()
response, err := client.Service.DownloadFile(
	ctx,
)
```
