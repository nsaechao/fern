...
[![go shield](https://img.shields.io/badge/go-docs-blue)](https://pkg.go.dev/github.com/folders/fern)
...
```sh
go get github.com/folders/fern
```
...
```go
import fernclient "github.com/folders/fern/client"
