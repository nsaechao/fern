...
import (
	...
	images "github.com/mixed-file-directory/fern/catalog/images"
	object "github.com/mixed-file-directory/fern/catalog/object"
...
func (c *Client) BatchDelete(
	ctx context.Context,
	request *fern.BatchDeleteCatalogObjectsRequest,
	opts ...option.RequestOption,
) (*fern.BatchDeleteCatalogObjectsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.BatchDeleteCatalogObjectsResponse
...
func (c *Client) BatchGet(
	ctx context.Context,
	request *fern.BatchGetCatalogObjectsRequest,
	opts ...option.RequestOption,
) (*fern.BatchGetCatalogObjectsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.BatchGetCatalogObjectsResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) BatchUpsert(
	ctx context.Context,
	request *fern.BatchUpsertCatalogObjectsRequest,
	opts ...option.RequestOption,
) (*fern.BatchUpsertCatalogObjectsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.BatchUpsertCatalogObjectsResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) Info(
	ctx context.Context,
	opts ...option.RequestOption,
) (*fern.CatalogInfoResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.CatalogInfoResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) List(
	ctx context.Context,
	request *fern.CatalogListRequest,
	opts ...option.RequestOption,
) (*core.Page[*fern.CatalogObject], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *fern.ListCatalogResponse) *core.PageResponse[*string, *fern.CatalogObject] {
		next := response.Cursor
		results := response.Objects
		return &core.PageResponse[*string, *fern.CatalogObject]{
			Next:    next,
			Results: results,
		}
	}
...
func (c *Client) Search(
	ctx context.Context,
	request *fern.SearchCatalogObjectsRequest,
	opts ...option.RequestOption,
) (*fern.SearchCatalogObjectsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.SearchCatalogObjectsResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) SearchItems(
	ctx context.Context,
	request *fern.SearchCatalogItemsRequest,
	opts ...option.RequestOption,
) (*fern.SearchCatalogItemsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.SearchCatalogItemsResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) UpdateItemModifierLists(
	ctx context.Context,
	request *fern.UpdateItemModifierListsRequest,
	opts ...option.RequestOption,
) (*fern.UpdateItemModifierListsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.UpdateItemModifierListsResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) UpdateItemTaxes(
	ctx context.Context,
	request *fern.UpdateItemTaxesRequest,
	opts ...option.RequestOption,
) (*fern.UpdateItemTaxesResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.UpdateItemTaxesResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
