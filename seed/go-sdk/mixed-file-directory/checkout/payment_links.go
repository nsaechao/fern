...
type CreatePaymentLinkRequest struct {
	...
	QuickPay *fern.QuickPay `json:"quick_pay,omitempty" url:"-"`
	...
	Order *fern.Order `json:"order,omitempty" url:"-"`
	// Describes optional fields to add to the resulting checkout page.
	// For more information,
	// see [Optional Checkout Configurations](https://developer.squareup.com/docs/checkout-api/optional-checkout-configurations).
	CheckoutOptions *fern.CheckoutOptions `json:"checkout_options,omitempty" url:"-"`
	...
	PrePopulatedData *fern.PrePopulatedData `json:"pre_populated_data,omitempty" url:"-"`
...
type UpdatePaymentLinkRequest struct {
	...
	PaymentLink *fern.PaymentLink `json:"payment_link,omitempty" url:"-"`
}
