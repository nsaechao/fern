...
func (c *Client) List(
	ctx context.Context,
	request *fern.CustomerAttributeDefinitionsListRequest,
	opts ...option.RequestOption,
) (*core.Page[*fern.CustomAttributeDefinition], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *fern.ListCustomerCustomAttributeDefinitionsResponse) *core.PageResponse[*string, *fern.CustomAttributeDefinition] {
		next := response.Cursor
		results := response.CustomAttributeDefinitions
		return &core.PageResponse[*string, *fern.CustomAttributeDefinition]{
			Next:    next,
			Results: results,
		}
	}
...
func (c *Client) Create(
	ctx context.Context,
	request *fern.CreateCustomerCustomAttributeDefinitionRequest,
	opts ...option.RequestOption,
) (*fern.CreateCustomerCustomAttributeDefinitionResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.CreateCustomerCustomAttributeDefinitionResponse
...
func (c *Client) Get(
	...
	key string,
	request *fern.CustomerAttributeDefinitionsGetRequest,
	opts ...option.RequestOption,
) (*fern.GetCustomerCustomAttributeDefinitionResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.GetCustomerCustomAttributeDefinitionResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) Update(
	...
	key string,
	request *fern.UpdateCustomerCustomAttributeDefinitionRequest,
	opts ...option.RequestOption,
) (*fern.UpdateCustomerCustomAttributeDefinitionResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.UpdateCustomerCustomAttributeDefinitionResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) Delete(
	...
	key string,
	opts ...option.RequestOption,
) (*fern.DeleteCustomerCustomAttributeDefinitionResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.DeleteCustomerCustomAttributeDefinitionResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
