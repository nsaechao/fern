...
func (c *Client) List(
...
) (*core.Page[*fern.TeamMemberWage], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *fern.ListTeamMemberWagesResponse) *core.PageResponse[*string, *fern.TeamMemberWage] {
		next := response.Cursor
		results := response.TeamMemberWages
		return &core.PageResponse[*string, *fern.TeamMemberWage]{
			Next:    next,
			Results: results,
		}
	}
...
func (c *Client) Get(
	...
	id string,
	opts ...option.RequestOption,
) (*fern.GetTeamMemberWageResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.GetTeamMemberWageResponse
