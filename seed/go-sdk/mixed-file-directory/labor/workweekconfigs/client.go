...
func (c *Client) List(
...
) (*core.Page[*fern.WorkweekConfig], error) {
	options := core.NewRequestOptions(opts...)
	...
	readPageResponse := func(response *fern.ListWorkweekConfigsResponse) *core.PageResponse[*string, *fern.WorkweekConfig] {
		next := response.Cursor
		results := response.WorkweekConfigs
		return &core.PageResponse[*string, *fern.WorkweekConfig]{
			Next:    next,
			Results: results,
		}
	}
...
func (c *Client) Get(
	...
	opts ...option.RequestOption,
) (*fern.UpdateWorkweekConfigResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.UpdateWorkweekConfigResponse
