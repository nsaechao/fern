...
type AccumulateLoyaltyPointsRequest struct {
	...
	AccumulatePoints *fern.LoyaltyEventAccumulatePoints `json:"accumulate_points,omitempty" url:"-"`
...
type AdjustLoyaltyPointsRequest struct {
	...
	AdjustPoints *fern.LoyaltyEventAdjustPoints `json:"adjust_points,omitempty" url:"-"`
...
type CreateLoyaltyAccountRequest struct {
	...
	LoyaltyAccount *fern.LoyaltyAccount `json:"loyalty_account,omitempty" url:"-"`
...
type SearchLoyaltyAccountsRequest struct {
	...
	Query *fern.SearchLoyaltyAccountsRequestLoyaltyAccountQuery `json:"query,omitempty" url:"-"`
