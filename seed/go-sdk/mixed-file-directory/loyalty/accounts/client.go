...
func (c *Client) Create(
...
) (*fern.CreateLoyaltyAccountResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.CreateLoyaltyAccountResponse
...
func (c *Client) Search(
	...
	opts ...option.RequestOption,
) (*fern.SearchLoyaltyAccountsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.SearchLoyaltyAccountsResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) Get(
	...
	accountId string,
	opts ...option.RequestOption,
) (*fern.GetLoyaltyAccountResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.GetLoyaltyAccountResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) AccumulatePoints(
	...
	opts ...option.RequestOption,
) (*fern.AccumulateLoyaltyPointsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.AccumulateLoyaltyPointsResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) Adjust(
	...
	opts ...option.RequestOption,
) (*fern.AdjustLoyaltyPointsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.AdjustLoyaltyPointsResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
