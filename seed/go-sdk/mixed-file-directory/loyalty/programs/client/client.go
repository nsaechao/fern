...
import (
	...
	promotions "github.com/mixed-file-directory/fern/loyalty/programs/promotions"
...
func (c *Client) List(
...
) (*fern.ListLoyaltyProgramsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.ListLoyaltyProgramsResponse
...
func (c *Client) Get(
	...
	programId string,
	opts ...option.RequestOption,
) (*fern.GetLoyaltyProgramResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := core.EncodeURL(baseURL+"/v2/loyalty/programs/%v", programId)

	headers := core.MergeHeaders(c.header.Clone(), options.ToHeader())

	var response *fern.GetLoyaltyProgramResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) Calculate(
	...
	opts ...option.RequestOption,
) (*fern.CalculateLoyaltyPointsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := core.EncodeURL(baseURL+"/v2/loyalty/programs/%v/calculate", programId)

	headers := core.MergeHeaders(c.header.Clone(), options.ToHeader())

	var response *fern.CalculateLoyaltyPointsResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
