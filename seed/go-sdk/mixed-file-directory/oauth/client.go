...
func (c *Client) Authorize(
	ctx context.Context,
	request *fern.OAuthAuthorizeRequest,
...
func (c *Client) RenewToken(
	ctx context.Context,
	// Your application ID, which is available in the OAuth page in the [Developer Dashboard](https://developer.squareup.com/apps).
	clientId string,
	request *fern.RenewTokenRequest,
	opts ...option.RequestOption,
) (*fern.RenewTokenResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.RenewTokenResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) RevokeToken(
	...
	opts ...option.RequestOption,
) (*fern.RevokeTokenResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.RevokeTokenResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
...
func (c *Client) ObtainToken(
	ctx context.Context,
	request *fern.ObtainTokenRequest,
	opts ...option.RequestOption,
) (*fern.ObtainTokenResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *fern.ObtainTokenResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:         endpointURL,
