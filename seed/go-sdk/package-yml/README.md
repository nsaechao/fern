...
[![go shield](https://img.shields.io/badge/go-docs-blue)](https://pkg.go.dev/github.com/package-yml/fern)
...
```sh
go get github.com/package-yml/fern
```
...
```go
import fernclient "github.com/package-yml/fern/client"
