...
[![go shield](https://img.shields.io/badge/go-docs-blue)](https://pkg.go.dev/github.com/plain-text/fern)
...
```sh
go get github.com/plain-text/fern
```
...
```go
import fernclient "github.com/plain-text/fern/client"
