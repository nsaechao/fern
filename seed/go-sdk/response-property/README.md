...
[![go shield](https://img.shields.io/badge/go-docs-blue)](https://pkg.go.dev/github.com/response-property/fern)
...
```sh
go get github.com/response-property/fern
```
...
```go
import fernclient "github.com/response-property/fern/client"
