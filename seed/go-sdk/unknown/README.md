...
[![go shield](https://img.shields.io/badge/go-docs-blue)](https://pkg.go.dev/github.com/unknown/fern)
...
```sh
go get github.com/unknown/fern
```
...
```go
import fernclient "github.com/unknown/fern/client"
