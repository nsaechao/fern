...
[![go shield](https://img.shields.io/badge/go-docs-blue)](https://pkg.go.dev/github.com/variables/fern)
...
```sh
go get github.com/variables/fern
```
...
```go
import fernclient "github.com/variables/fern/client"
